...
def clasificar_sueldos(sueldos):
    ...
    for trabajador, sueldo in sueldos.items():
        if sueldo < 800000:
            menores_800k.append((trabajador, random.choice(cargos), sueldo))
        elif 800000 <= sueldo <= 2000000:
            entre_800k_y_2m.append((trabajador, random.choice(cargos), sueldo))
        else:
            superiores_2m.append((trabajador, random.choice(cargos), sueldo))
        ...
        if opcion == '1':
            ...
            if not sueldos:
                ...
                for emp in menores_800k:
                    print(f"{emp[0]:<15} {emp[1]:<15} ${emp[2]:,.0f}")
